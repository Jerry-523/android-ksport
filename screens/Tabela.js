...
const CONTENT = {
  ...
  tableTitle: ['Batuque', 'Derby', 'Mindelense', 'Academica', 'F. do Norte', 'Farense', 'Castilho', 'Salamansa'], tableTitle2: ['Benfica Santa Cruz', 'G D Varandinha', 'Esperança FC', 'SC Beira Mar', 'Flor Jovem', 'S. L. Orgãos', 'G D Nhagar'],
  tableData: [
    ['0', '0', '0'],
    ['0', '0', '0'],
    ['0', '0', '0'],
...
export default class Tabela extends Component{
  render(){
    return (
      <Drawer.Navigator initialRouteName="Campeonato Santiago Norte"  screenOptions={{ headerStyle: { backgroundColor: 'gold' },}}>
        <Drawer.Screen name="Taça de Cabo Verde" component={TacaCaboVerde} />
        <Drawer.Screen name="Campeonato Santiago Norte" component={SantiagoNorte} />
        ...
        <Drawer.Screen name="Campeonato Santo Antão Norte" component={SantoAntaoNorte} />
        <Drawer.Screen name="Campeonato Santo Antão Sul" component={SantoAntaoSul} />
